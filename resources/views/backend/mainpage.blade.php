...
<div class="container-full">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-xl-6 col-12">
                <div class="box bg-info bg-img" style="background-image: url(https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/gallery/bg-1.png)">
                    <div class="box-body text-center">
                        <img src="https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/trophy.png" class="mt-50" alt="" />
                ...
                <div class="box overflow-hidden">
                    <div class="box-body p-0">
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="box no-shadow mb-0 bg-img rounded-0" data-overlay="5" style="background-image: url(https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/gallery/landscape7.jpg)">
                                    <div class="box-header no-border">
                                        <h4 class="box-title mb-0">
                                ...
                                <tbody>
                                        ...
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url(https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/gallery/creative/img-1.jpg)"></div>
                                                </div>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url(https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/gallery/creative/img-2.jpg)"></div>
                                                </div>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url(https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/gallery/creative/img-3.jpg)"></div>
                                                </div>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url(https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/gallery/creative/img-4.jpg)"></div>
                                                </div>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url(https://html.psdtohtmlexpert.com/admin/sunny-admin-template/images/gallery/creative/img-5.jpg)"></div>
                                                </div>
